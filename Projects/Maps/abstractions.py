...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 2
    # I used dictionary implementation since it's easier to identify an attribute by calling its name. 
    # For example, if I want a restaurant's name, I can simply call restaurant['name']
...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 2
    # A review consists of a list containing restaurant_name and rating. The rating can be
    # accessed via review_rating selector
