...
def key_of_min_value(d):
    ...
    """
    # BEGIN Question 0
    # the lambda x: d[x] means the min function searches through the values, not the keys,
    # but returns the keys that correspond to the found value
...
def enumerate(s, start=0):
    ...
    """
    # BEGIN Question 0
    # 1st argument is a range of numbers starting from 'start' (default value is 0) to 'start' + len(s)
    # 2nd argument is just s
