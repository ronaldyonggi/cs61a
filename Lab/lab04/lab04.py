...
def distance(city1, city2):
    ...
    long_dif = get_lon(city1) - get_lon(city2)
    # Now calculate the distance
    return ((lat_dif ** 2) + (long_dif ** 2)) ** 0.5
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    # Use the provided lat and lon to create a "city" called coordinate
    coordinate = make_city('coordinate', lat, lon)
    # Now use if to return the name of the city that's closest to coordinate
