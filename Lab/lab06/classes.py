...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        # Add the attack and defense of the opponent's card to all cards in the player's deck
        for card in player.deck.cards:
            card.attack += other_card.attack
            card.defense += other_card.defense
        # Remove opponent cards that have the same attack/defense as the other_card
